...
export const Skills = (): JSX.Element => {
  return (
    <div className="p-5 rounded-sm flex flex-col justify-center items-center">
      <div className="p-2 flex justify-around items-center border-l-4 border rounded-lg border-slate-100 bg-stone-800">
        <img
          src="./img/js.png"
          className="w-20 duration-300 hover:-translate-x-2 hover:-translate-y-2"
        ></img>
        <img
          src="./img/ts.png"
          className="w-20 duration-300 hover:-translate-y-2"
        ></img>
        <img
          src="./img/react.png"
          className="w-20 duration-300 hover:-translate-y-2 animate-spin-slow"
        ></img>
        <img
...
export const Projects = (): JSX.Element => {
  ...
  const DietApp = (): JSX.Element => {
    return (
      <div>
        <button onClick={() => setShow(null)}>VOLTAR</button>
        <div className="flex-col justify-center">
          <img src="./img/macro.png" className={`rounded-md`}></img>
          <p>
